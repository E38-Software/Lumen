...
export const environment = {
  ...
  isMockEnabled: true,
  apiUrl: "api",
  // parseUrl: 'https://parse.e38.it/parse',
  // parseUrl: 'https://parseapi.back4app.com',
  // parseUrl: 'https://scavvocatiassociati.b4a.io',
  parseUrl: "http://localhost:1337/parse",
  // parseUrl: 'https://parse-server-test.azurewebsites.net/parse',
 
 
  // APPLICATION_ID: 'APPLICATION_ID',
  // APPLICATION_ID: 'qN8NEh6kxHQJauFdioUVj2csOHdPGipSmitxZzmF',
  APPLICATION_ID: 'avvocati_sc_demo',
  // APPLICATION_ID: 'CJ5lkqSrtEP4eU8X8Np7vITSAU26VjAfdOPQqwCB',
  
  parseConfig: {
    applicationId: 'avvocati_sc_demo',
    javascriptKey: 'avvocati_js_key', // Add your JavaScript key here
  ...
  // Anche Javascript ID
  // JAVASCRIPT_KEY: 'IR2ljg9hMv9FvsxtvQD4Fk1kYqH8RDNhEEbUHKEI',
  JAVASCRIPT_KEY: 'ScNett0nz1oisli',
  // JAVASCRIPT_KEY: 'd6Ps8dP73P6yRbmBb2otGfsGicJdeARpyVV9DaIb',
  // JAVASCRIPT_KEY: 'ScNett0nz1oisli',
  
  
  // LIVE_QUERY_SERVER: 'wss://scavvocatiassociati.b4a.io',
  LIVE_QUERY_SERVER: 'ws://localhost:1337/parse',
  // LIVE_QUERY_SERVER: 'wss://demoscavvocati.b4a.io',
  // LIVE_QUERY_SERVER: 'wss://parse-server-test.azurewebsites.net/parse',

  exportFuncUrl: "https://export-servanda-light.azurewebsites.net/api/Export-Servanda?code=_LG0YTmPJYGKA8TV9cKOnzT-UcA7ArS-Tdve6Z3RpFhyAzFuPmV9bg%3D%3D",
  // ocrUrl: "http://localhost:7071/api/ProcessFileFunction",
  
  ocrUrl: "https://scpdf.azurewebsites.net/api/processfilefunction?code=X4-1NkE69Zpzh7tBjrAVM49dlOSgGXS-n5XkmKki_A7NAzFu2iMyrA%3D%3D",

  allowedPagesWithoutLoading: [
    /\/judicial-procedures\/notes/,
    /\/error\/403$/
  ] as RegExp[],
